...
void AUnitBase::Tick(float DeltaSeconds)
{
    ...
    // Debug: Only update movement when MoveStatus is Moving
...
void AUnitBase::MoveUnit(const TArray<FVector>& InPath)
{
    ...
    // Debug: Log MoveUnit call details
    ...
    // Truncate path if it exceeds movement range
